...
## TỔNG QUAN & PHÂN BIỆN
**Tác giả:** Ôn Như Nguyễn Văn Ngọc, Từ An Trần Lê Nhân (1925)
**Bối cảnh:** Hà Nội thập niên 20. Mục tiêu: Bảo tồn tinh hoa Hán học trước sức mạnh của Tân học phương Tây.

> *"Cựu học ... đã làm cho ông cha ta phù thực được cương thường, chấn chỉnh được phong hóa"*

## 🔍 PHÂN BIỆN LƯỠNG DIỆN (The Dual Critique)
1. **Giá trị cốt lõi (70%):** Vẫn nguyên vẹn. Human nature constants — con người tham, sợ, kiêu ngạo, hèn nhát vẫn y nguyên sau 2500 năm. Truyện cổ là pattern of civilization.
2. **Blindspot của tác giả (~30%):** Thiên kiến Nho giáo trong phần "Lời Bàn". Gán ghép đạo đức thay vì phân tích logic hoặc kinh tế học hành vi. Cần lọc bỏ lớp vỏ "đạo lý" để lấy hạt nhân "chiến lược".

## 🎓 BÀI HỌC CHÍNH (4 Trục Tư Duy)
1. **Timeless Patterns:** "Cơ học" trong tên sách không phải vật lý, mà là quy luật hành vi. *Pattern: Hành vi con người constants qua thời gian.*
2. **Lời Bàn = Bias của Thời đại:** Cần phân biệt "Sự kiện truyện" và "Bình luận tác giả". Bình luận thường thiên về Nho gia (hiếu - trung - nghĩa), cần đối chiếu với视角 Pháp gia, Mặc gia để đa chiều.
3. **Two-Layer Critique Methodology:** Phân biện đúng chuẩn = Kiểm chứng Factual + Kiểm chứng Modern Applicability. (Tham lợi ích trước mắt vs Infinite game thinking).
4. **Adaptation > Knowledge:** Người "lưu lạc" thực sự là người có kiến thức nhưng không đổi mới được phương pháp sống theo thời thế ("Ôm cây đợi thỏ", "Đánh dấu thuyền tìm gươm").
...
## 🛠️ NHIỆM VỤ HÀNH ĐỘNG (Action Items)
- [ ] **Tuần 1:** Chọn 3 truyện kinh điển nhất ("Tham thì chết", "Học trò giỏi", "Lừa đất Kiểm") để viết application note thực tế vào công việc hiện tại.
- [ ] **Rut kinh nghiệm:** Khi đọc sách văn học/cổ, áp dụng pattern `Extract Core Pattern -> Check Confucian Bias -> Map to Modern Domain`.
